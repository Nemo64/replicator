...
import {Environment, Initializer, SourceEvent} from "./drivers/types";
import {AsyncMergeIterator} from "./util/async_merge_iterator";
import {generateViews} from "./view";

// public api

export {Config, ViewConfig, Mapping, ViewMapping, Mappings} from "./config";
...
/**
 * This method takes a configuration and allows to iterate {@see SourceEvent}'s.
 ...
 */
export function watchForEvents(mappings: Mappings): AsyncIterable<SourceEvent> {
 ...
 * You can also generate your own {@see SourceEvent}, if your environment requires this.
 */
export function processEvent(mappings: Mappings, event: SourceEvent): Promise<Update> {
